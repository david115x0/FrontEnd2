...
// varios objetos dentro de um array, cada objeto tem title, description -> cada objeto h2, p


/*const felino1 = document.querySelector('.felino1');
felino1.innerHTML = `<h2>${listadeFelinos[0].title}</h2> <p>${listadeFelinos[0].description}</p>`;*/

const btn = document.querySelector('.btn');

// Conversão para parray
const todasClasses = document.querySelectorAll("article");
let todasClassesArray = Array.prototype.slice.call(todasClasses);
console.log(todasClasses);

//Definimos o botão 
btn.addEventListener("click", () => {
    todasClassesArray.map(function(item, indice){
